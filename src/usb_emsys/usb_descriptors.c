...
static const unsigned char Device_Descriptor[] =
{
	...
	(PAPA_SCHLUMPF_USB_VENDOR_ID&0xff),       (PAPA_SCHLUMPF_USB_VENDOR_ID>>8),       // vendor ID
	(PAPA_SCHLUMPF_USB_PRODUCT_ID&0xff),      (PAPA_SCHLUMPF_USB_PRODUCT_ID>>8),      // product ID
	(PAPA_SCHLUMPF_USB_PRODUCT_RELEASE&0xff), (PAPA_SCHLUMPF_USB_PRODUCT_RELEASE>>8), // product release ID (BCD)
